...
interface IStaking {
    ...
    event StakeDeposit(
        address from,
        address indexed to,
        uint256 poolId,     // poolId could be determined based on the strategy
    ...
    /**
     * @notice Deposits a specified stake amount into a staking pool with a chosen strategy
    ...
    /**
     * @notice Withdraws a specified stake amount from a staking pool, including revenue generated by
     *         the strategy
