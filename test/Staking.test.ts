...
describe("Staking", function () {
  ...
  describe("Staking", function () {
    ...
    it("should be able to deposit stake", async function () {
      ...
      expect(vaultInfo.totalAllocation).to.equal(stakeAmount * 2n + stakeAmountForAlice); // TODO move to allocation, where price is different
    });
    ...
    //     .withArgs(owner, owner, reserveStrategy1, withdrawAmount, depositType);
    //
    ...
    //
    //   // Allocation
    //   const vaultInfo = await allocation.tier1Info(reserveStrategy2);
    //   expect(vaultInfo.totalStake).to.equal(stakeAmount - 3n * withdrawAmount);
    //
    //   // UserInfo
    //   expect(
    //     (await allocation.userTier1Info(reserveStrategy2, owner)).stake,
    //   ).to.equal(stakeAmount - 3n * withdrawAmount);
    //   expect(
    //     (await allocation.userTier1Info(reserveStrategy2, alice)).stake,
    //   ).to.equal(0);
    // });
